...
import { NUTRITION_ITEMS, MAX_CALORIES } from "./Constants";


const NutritionMeter = () => {
  const defaultItemsDisplayed = [...NUTRITION_ITEMS];
  ...
  useEffect(() => {
    ...
    if (calculateTotalCalories > MAX_CALORIES) {
      setShowWarning(true);
    } else {
      ...
      <div className="container mx-auto p-4">
        ...
        {showWarning && (
          <div className="bg-red-500 text-white p-2 rounded-md text-center mb-4">
            ...
            Total calories exceed recommended limit ({MAX_CALORIES} calories)!
          </div>
        )}
        <div className="mb-4">
